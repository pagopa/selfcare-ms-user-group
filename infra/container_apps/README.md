...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_container_app_user_group"></a> [container\_app\_user\_group](#module\_container\_app\_user\_group) | github.com/pagopa/selfcare-commons//infra/terraform-modules/container_app_microservice | main |
